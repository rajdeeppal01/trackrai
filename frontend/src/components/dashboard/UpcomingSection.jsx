          ...
          <AnimatePresence>
            {upcoming.map((app, i) => (
              <motion.div
                ...
                onClick={() => onEdit(app)}
                className="flex items-center gap-3 p-3 rounded-xl bg-white/3 border border-white/5 hover:bg-white/6 hover:border-white/10 cursor-pointer transition-all duration-200 group"
              >
                {/* Status icon */}
