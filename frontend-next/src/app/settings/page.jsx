...
export default function Settings() {
 ...
 <div className="w-9 h-9 rounded-3xl bg-white/5 flex items-center justify-center">
 ...
 className="w-full rounded-[6px] bg-white/3 px-3.5 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-indigo-500 transition-colors"
 />
 </div>
 <div className="space-y-1">
 ...
 rows={3}
 className="w-full rounded-[6px] bg-white/3 px-3.5 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-indigo-500 transition-colors resize-y"
 />
 </div>
 ...
 { label: 'Frontend', value: 'Next.js 15 + React 19 + Tailwind v4' },
 { label: 'Total Applications', value: String(applications.length) },
 ].map(({ label, value }) => (
 <SettingRow key={label} label={label}>
 <span className="text-xs text-white/40 font-mono bg-white/5 px-2.5 py-1 rounded-2xl">{value}</span>
 </SettingRow>
 ))}
 </Section>
 ...
 className="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold rounded-3xl bg-red-500/10 border border-red-500/25 text-red-400 hover:bg-red-500/20 hover:text-red-300 transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed"
 >
 <Trash2 size={12} />
 Clear All
 </button>
