...
function InsightCard({ insight, index }) {
 const styles = {
 stat: { border: 'border-indigo-500/20', iconBg: 'bg-indigo-500/10', badge: 'bg-indigo-500/20 text-indigo-300', label: 'Insight' },
...
function TipCard({ icon: Icon, title, body, color, border }) {
 ...
 >
 <div className={`w-9 h-9 rounded-3xl ${color} flex items-center justify-center mb-3`}>
...
export default function AICopilot() {
 ...
 <h1 className="text-3xl font-extrabold bg-gradient-to-r from-indigo-400 to-purple-400 text-transparent bg-clip-text drop-shadow-sm tracking-tight">AI Copilot</h1>
 </div>
 ...
 <div className="flex items-center gap-3 border-b pb-4 mb-4 border-white/5">
 <div className="w-9 h-9 rounded-3xl bg-purple-500/10 flex items-center justify-center">
 ...
 >
 <div className={`w-8 h-8 rounded-2xl flex items-center justify-center shrink-0 text-white ${
 ...
 : 'bg-white/5 text-white/90 rounded-tl-none font-light'
 }`}>
 ...
 <div className="w-8 h-8 rounded-2xl flex items-center justify-center bg-purple-500/20 border border-purple-500/30">
 <Bot size={14} className="text-purple-400" />
 </div>
 <div className="bg-white/5 text-white/40 p-3 rounded-2xl rounded-tl-none flex items-center gap-1">
 ...
 className="flex-1 glass rounded-3xl px-4 py-3 text-sm text-white placeholder-white/20 focus:outline-none focus:border-purple-500 transition-colors disabled:opacity-55"
 />
 <button
 type="submit"
 disabled={chatLoading || !chatInput.trim()}
 className="w-11 h-11 rounded-3xl bg-purple-500 hover:bg-purple-600 active:scale-95 transition-all text-white flex items-center justify-center cursor-pointer disabled:opacity-40 disabled:scale-100 disabled:cursor-not-allowed"
 >
 <Send size={16} />
 </button>
 </form>
