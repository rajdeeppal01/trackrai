...
export default function ApplicationGrid({ applications = [], loading, onEdit, onDelete, submitting }) {
 ...
 <div className="skeleton h-10 w-full max-w-md rounded-3xl" />
 ...
 <div className="flex items-center gap-2 text-xs text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 rounded-3xl px-4 py-2">
 <Plus size={14} />
 ...
 className="w-full pl-9 pr-4 py-2.5 glass rounded-3xl text-sm text-white placeholder-white/25 focus:outline-none focus:border-indigo-500 transition-all duration-200"
 />
 </div>
 </div>
