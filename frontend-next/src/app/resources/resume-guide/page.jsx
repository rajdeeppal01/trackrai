...
export const metadata = {
  title: 'ATS Resume Guide & Best Practices | TrackrAI',
  description: 'Learn how to beat the ATS and get your resume read by human recruiters. Follow our step-by-step resume guide for job hunters.',
  openGraph: {
    title: 'ATS Resume Guide & Best Practices | TrackrAI',
    description: 'Learn how to beat the ATS and get your resume read by human recruiters. Follow our step-by-step resume guide for job hunters.',
  }
  ...
  return (
    <div className="min-h-screen bg-[#050510] text-white font-sans py-12 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10 space-y-8">
        ...
        {/* Content Guide */}
        <article className="glass rounded-2xl p-6 space-y-6 leading-relaxed text-sm text-white/70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {tips.map((tip, idx) => (
              <div key={idx} className="p-4 rounded-3xl bg-white/2 space-y-2">
          ...
          {/* Alert block */}
          <div className="p-4 rounded-3xl bg-yellow-500/10 border border-yellow-500/20 flex items-start gap-3">
        ...
        {/* CTA section */}
        <div className="glass rounded-3xl p-8 bg-gradient-to-r from-purple-950/10 to-[#080820] text-center space-y-4 max-w-2xl mx-auto border border-purple-500/10">
