...
export default function ActivityFeed({ activity = [] }) {
 ...
 <div className="w-7 h-7 rounded-2xl bg-indigo-500/10 flex items-center justify-center">
 ...
 className="flex items-start gap-3 p-3 rounded-3xl bg-white/3 hover:bg-white/5 transition-colors duration-200"
 >
 <div className={`w-7 h-7 rounded-2xl ${typeConf.bg} flex items-center justify-center flex-shrink-0 mt-0.5`}>
