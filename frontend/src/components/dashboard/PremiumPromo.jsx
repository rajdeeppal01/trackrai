      ...
      <div className="relative p-6 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="pt-2">
            <Link
              to="/premium"
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-white text-indigo-950 font-bold text-sm hover:bg-indigo-50 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] active:scale-95"
            >
              Unlock AI Sync
              <ArrowRight size={14} />
            </Link>
        ...
        <div className="hidden md:flex flex-col items-center justify-center relative w-64 shrink-0">
          ...
          <motion.div 
            ...
            className="w-full glass-strong rounded-xl p-3 border border-white/10 shadow-2xl relative z-10"
          >
          ...
          <motion.div 
            ...
            className="w-11/12 bg-[#0a0a1a] rounded-xl p-3 border border-emerald-500/30 shadow-2xl relative z-10 flex items-center gap-3"
          >
