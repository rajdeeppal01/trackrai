...
[LinkedIn Profile]`
 ...
 >
 {/* Template Header */}
 <div className="px-6 py-4 border-b bg-white/2 flex items-center justify-between gap-4">
 ...
 {/* CTA section */}
 <div className="glass rounded-3xl p-8 bg-gradient-to-r from-indigo-950/10 to-[#080820] text-center space-y-4 max-w-2xl mx-auto">
