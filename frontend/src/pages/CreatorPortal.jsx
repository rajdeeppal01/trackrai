...
function CustomTooltip({ active, payload, label }) {
  ...
  return (
    <div className="glass-strong rounded-xl px-3 py-2 shadow-xl border border-white/10 text-xs space-y-1">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                const Icon = kpi.icon;
                return (
                  <div key={idx} className="glass rounded-2xl p-4 border border-white/5 flex flex-col justify-between h-28">
                    <div className="flex items-start justify-between">
                      <p className="text-[10px] text-white/40 font-bold uppercase tracking-wider">{kpi.title}</p>
                      <div className={`w-6 h-6 rounded-lg ${kpi.bg} ${kpi.color} flex items-center justify-center`}>
                        <Icon size={12} />
                      </div>
                    </div>
                    <div>
