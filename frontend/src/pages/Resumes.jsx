...
export default function Resumes() {
 ...
 <div className="bg-amber-500/10 border border-amber-500/20 text-amber-400 px-4 py-2 rounded-3xl text-sm flex flex-col sm:flex-row items-center gap-3">
 <span>Free Plan Limit Reached (2/2)</span>
 <Link to="/premium" className="bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 px-3 py-1 rounded-2xl transition-colors font-semibold text-xs">
 Upgrade to Premium
 </Link>
 </div>
 ) : (
 ...
 <div className="border border-dashed rounded-2xl p-12 text-center bg-white/5">
 ...
 className={`glass rounded-2xl p-5 border relative group transition-colors ${resume.is_default ? 'border-indigo-500/50 bg-indigo-500/5' : ' hover:border-white/20'}`}
 >
 <div className="flex justify-between items-start mb-4">
 <div className="p-3 bg-white/5 rounded-3xl text-indigo-400">
 <FileText size={24} />
 </div>
 {resume.is_default && (
 ...
 title="Download PDF"
 className="w-8 h-8 rounded-2xl bg-white/5 hover:bg-white/10 flex items-center justify-center text-white/60 hover:text-white transition-colors"
 >
 <FileDown size={14} />
 </button>
 {!resume.is_default && (
 ...
 className="w-8 h-8 rounded-2xl bg-white/5 hover:bg-indigo-500/20 flex items-center justify-center text-white/60 hover:text-indigo-400 transition-colors"
 >
 ...
 title="Delete Resume"
 className="w-8 h-8 rounded-2xl bg-red-500/5 hover:bg-red-500/20 flex items-center justify-center text-red-500/60 hover:text-red-400 transition-colors"
 >
 <Trash2 size={14} />
 </button>
 </div>
